=== Plugin Name ===
Contributors: carlosvarela
Tags: dollynho, brasil
...
Contribute to the plugin, submit pull requests, or run test suites through the [GitHub repository](https://github.com/carlosvarela/dollynho). 
